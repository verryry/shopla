	      ...
	      <div class="header-icons">
	        ...
	        <a href="{{ route('login')}}" class="header-wrapicon1 dis-block">
	          <i class="fa fa-user fa-lg"></i> Login
					...
					@else
					<br>
					<label for=""><i class="fa fa-user fa-lg"></i> {{ Auth::user()->name }}</label>
					@endguest
...
<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
  ...
  <div class="t-center p-l-15 p-r-15">
    ...
    <div class="t-center s-text8 p-t-20">
      Copyright © 2018 All rights reserved. | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by Technosoft
    </div>
  </div>
</footer>
	<!-- Back to top -->
