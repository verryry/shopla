            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Newsletter <span class="label label-rouded label-primary pull-right">2</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="email-compose.html">List Email</a></li>
                                <li><a href="email-read.html">Add Email</a></li>
                                <li><a href="email-inbox.html">Send Email</a></li>
                            </ul>
                        </li>
                        <li class="nav-label">Features</li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Product<span class="label label-rouded label-warning pull-right">6</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ route('product.index') }}">List Product</a></li>
                                <li><a href="{{ route('product.create') }}">Add Product</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Category<span class="label label-rouded label-warning pull-right">6</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ route('category.index') }}">List Category</a></li>
                                <li><a href="{{ route('category.create') }}">Add Category</a></li>
                            </ul>
                        </li>
						            <li> <a class="" href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">About</span></a></li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-wpforms"></i><span class="hide-menu">Contact</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="" href="#" aria-expanded="false"><i class="fa fa-columns"></i><span class="hide-menu">Orders</span></a></li>
                        <li class="nav-label">Settings</li>
                        <li> <a class="" href="#" aria-expanded="false"><i class="fa fa-columns"></i><span class="hide-menu">Footer Setting</span></a></li>
                        <li> <a class="" href="#" aria-expanded="false"><i class="fa fa-columns"></i><span class="hide-menu">Banner Setting</span></a></li>
