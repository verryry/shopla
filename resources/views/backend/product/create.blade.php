                            ...
                            @csrf
                              <div class="row">
                                  <div class="col-lg-6">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <select class="form-control" name="id_category">
                                            <option selected="true" disabled="disabled">Chooise Category</option>
                                  ...
                                  <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Price</label>
                                        <input type="number" min="0" name="price" class="form-control" placeholder="Price Product">
                                    </div>
                                    <!-- <div class="form-group">
                                        <label>Size</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" min="0" type="number" name="quantity" placeholder="Quantity">
                                    </div>
                                    <div class="form-group">
                                        <label>Descripton</label>
                                        <textarea style="height:auto !important;" class="form-control" rows="10" name="description" placeholder="Descripton Product"></textarea>
                                    </div>
                                  </div>
                              </div>
